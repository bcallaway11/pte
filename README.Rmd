...
The `pte` package can be used with the empirical bootstrap.  There are a few limitations.  First, it's going to be substantially slower.  Second, this code just reports pointwise standard errors.  This basically is set up to fit into my workflow, and I see this as a way to get preliminary results.
